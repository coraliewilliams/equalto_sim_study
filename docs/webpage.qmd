...
Below, we show how to fit a meta-analysis using the `equalto` covariance structure in `glmmTMB` R package, which allows to specify the sampling error variance-covariance (VCV) matrix.
